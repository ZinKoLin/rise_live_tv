...
public class Live implements Serializable {
    ...
    public Live(int id, String channelImage, String channelName, String channelCategory, String channelType, String channelLink, String channelDesc, String channelLanguage) {
        this.id = id;
