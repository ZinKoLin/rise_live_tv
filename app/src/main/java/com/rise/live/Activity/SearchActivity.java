            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    for (int i = 0; i < favList.size(); i++) {
                        if (favList.get(i).getChannelName().contains(categoryName) || favList.get(i).getChannelCategory().contains(categoryName) ||
                                favList.get(i).getChannelName().contains(upperCase)){
